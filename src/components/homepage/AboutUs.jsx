...
const team = [
    ...
    {
        name: "Franky Mallma",
        image: "https://i.ibb.co/CKqT5JMG/Franky.jpg",
        videoTimestamp: 55,
    }
];
...
const positions = [
    ...
    { angle: -1.38, distance: 180, size: 160 },
    { angle: -0.20, distance: 120, size: 110 },
    { angle: 0.60, distance: 170, size: 90 },
    { angle: 1.05, distance: 240, size: 70 },
];
